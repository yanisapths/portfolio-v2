...
function Banner() {
  return (
    <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600] 2xl:h-[700px] font-noto ">
          <Image  src="/asset/h-olive.png" 
           layout="fill"
           objectFit="cover"
           className="opacity-40"
           />
           <div className="absolute top-1/4 md:top-1/3 w-full text-center">
             <p className="text-white text-3xl md:text-5xl  font-black shadow-4xl opacity-100 p-3">Olive Platform</p>
             ...
             <Link href="https://o-live.vercel.app">
               Visit site
              </Link>

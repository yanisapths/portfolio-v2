  ...
  <button
        ...
        >
          <div className='lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto  transition transform duration-200 ease-out'>
            <Link href='/'>
              <p className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold text-xl items-center justify-center hover:text-indigo-400  hover:font-extrabold transition transform duration-300 ease-out'>
                Home
              </p>
            </Link>
            <Link href='/about'>
              <p className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold  text-xl items-center justify-center hover:text-sky-400 hover:font-extrabold transition transform duration-300 ease-out'>
                About
              </p>
            </Link>
            <Link href='/projects'>
              <p className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold  text-xl items-center justify-center  hover:text-emerald-400  hover:font-extrabold transition transform duration-300 ease-out'>
              Projects
              </p>
            </Link>
          </div>

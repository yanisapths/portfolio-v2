    ...
    <section>
        <div className="px-8 py-16 mx-auto max-w-screen-2xl sm:px-6 lg:px-60 xl:px-96 xl:mt-10 xl:mb-40" >
            ...
            <div className="relative flex items-center bg-indigo-200 lg:h-[24rem] xl:h-[24rem]   xl:w-[32rem] ml-8 -mt-8 shadow-2xl">
                ...
                <div   className="inline-block font-bold px-12 py-3 mt-8 text-md text-indigo-200 bg-[#070738] border border-indigo-400 rounded-lg active:text-indigo-400 hover:bg-white hover:text-indigo-400 focus:outline-none focus:ring shadow-indigo-400 shadow-md">
                <Link
                    href="/about"
                >
                    Read

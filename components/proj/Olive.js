  ...
  return (
    ...
    <div className="max-w-8xl mx-auto  overflow-hidden xl:max-w-4xl pb-20 ">
        <div className="relative lg:mt-20 xl:mt-20 mt-10 inline-block px-4 py-2 lg:px-8 lg:py-3 xl:px-8 xl:py-3 md:px-8 md:py-3 overflow-hidden   group focus:outline-none focus:ring ">
         ...
         <Canva />
         <div  className=" xl:mt-48 lg:mt-36 bg-black/40 w-60 ml-10 lg:ml-[23rem] xl:ml-80 md:ml-80 lg:w-64 xl:w-64 justify-center  border-2 mt-8 cursor-pointer transform hover:translate-x-2 transition duration-300 shadow-white shadow-lg rounded-full px-6 py-2  hover:bg-[#ffffff] hover:border-2 hover:text-indigo-400">
            <Link
                href="/projects/"
                >

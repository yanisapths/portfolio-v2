    ...
    <section className="mx-8 bg-[#070738]">
      ...
      <div className="bg-[#070738] justify-center xl:grid xl:grid-cols-2 lg:grid lg:grid-cols-2  ">
        ...
        <div className="max-w-6xl mx-auto  py-10 pb-40 xl:pl-90">
          <img
            src="/asset/user.jpg"
            className=" rounded-xl  sm:w-[50%] xl:w-[40%]"
          />
        ...
        <div className="mx-auto xl:py-10 lg:py-10 pb-40 lg:-ml-32 xl:-ml-72 ">
          ...
          <div className="flex flex-row">
            ...
            <div className="basis-2/3 ">
              ...
              <h5 className=""> JavaScript, Python, CSS/HTML, Solidity</h5>
              <h3 className=" lg:text-lg text-indigo-600 font-bold">Design</h3>
              <h5 className="">User Story, Design System, Prototyping, Wireframing</h5>

              <h3 className=" lg:text-lg text-indigo-600 font-bold">Protocols</h3>
              <h5 className="">XML REST JSON</h5>
              <h3 className=" lg:text-lg text-indigo-600 font-bold">
                Frameworks
              </h3>
              <h5 className="">Express.js, React.js, Next.js, Node.js, Django, Git, Vercel, Flutter, Firebase, 
Docker, GCP, AWS, Linux, Ubuntu</h5>
            </div>
          </div>
          {/* Work */}
          ...
          <div className="flex flex-row">
            ...
            <div className="basis-2/3">
              ...
              <h5 className=" ">
                Member of debate team for English Department
              </h5>
            </div>
          </div>
          ...
          <div className="flex flex-row">
            <div className="basis-1/3 ">
              <h3 className=" lg:text-md text-indigo-700 lg:pl-10  mt-4">
                1 Dec 2021
              </h3>
              <h3 className=" lg:text-md text-indigo-700 lg:pl-10  mt-28  xl:mt-28 lg:mt-28 md:mt-24">
                5 Dec 2021
              </h3>
              <h3 className=" lg:text-md text-indigo-700 lg:pl-10  mt-32  xl:mt-28 lg:mt-24 md:mt-20">
                12 Dec 2021
              </h3>
              <h3 className=" lg:text-md text-indigo-700 lg:pl-10  mt-32   xl:mt-24 lg:mt-24 md:mt-20  ">
                30 Jan 2021
              </h3>
            </div>
            <div className="basis-2/3 ">
              <h3 className=" lg:text-lg text-indigo-600 font-bold mt-3 xl:mt-0 lg:mt-0  ">
              ...
              <h3 className=" lg:text-lg text-indigo-600 font-bold mt-6 xl:mt-12">
              ...
              <h3 className=" lg:text-lg text-indigo-600 font-bold  mt-8 lg:mt-6 xl:mt-10">
                HCIA-Cloud Service
              </h3>

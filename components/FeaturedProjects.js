    ...
    <section className="mx-8 lg:mx-5  md:mx-10 bg-[#070738]">
      ...
      <div className="bg-[#070738] justify-center align-center -mt-40 xl:mt-0 lg:mt-0 md:-mt-16">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 py-20 pb-40">
          {/* Single card */}
          <div className=" lg:w-full lg:h-5/6 flex flex-row col-span-3 shadow-2xl">
            <div className="lg:basis-1/3 basis-1/2 relative overflow-hidden">
              <Image
                src="/asset/olivepreview.png"
                alt="portfolio"
                width={400}
                height={450}
                objectFit="cover"
                className="opacity-60 transform hover:scale-125 transition duration-2000 ease-out"
              />
            ...
            <div className="lg:basis-2/3 basis-1/2 ">
              ...
              <p className="m-5 lg:text-lg md:text-xl md:mx-14  shadow-white drop-shadow-2xl text-xs font-bold"  style={{background:'linear-gradient(90deg, #008BFF 15.7%, #16C8F7 35.94%, rgba(147, 115, 249, 0.965091) 104.01%, rgba(131, 71, 238, 0.92) 123.02%)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  backgroundClip: 'text',
                  textFillColor: 'transparent' }}>Scholarship Awarded from D-Plus Intertrade Co., Ltd</p>
              <p className="m-5 mx-14 lg:text-lg md:text-xl text-white text-xs">
              ...
              <h1 className="pr-6 text-indigo-500 text-sm w-full justify-center p-2 text-right">
                Next.js ★ MongoDB ★ Tailwind CSS ★ Express ★ <span  style={{background:'linear-gradient(90deg, #008BFF 15.7%, #16C8F7 35.94%, rgba(147, 115, 249, 0.965091) 104.01%, rgba(131, 71, 238, 0.92) 123.02%)',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  backgroundClip: 'text',
                  textFillColor: 'transparent' }} className="font-semibold shadow-white drop-shadow-2xl ">Full-Stack</span>
              </h1>
            </div>
          </div>
          {/* Single card */}
          <div className="  lg:w-full lg:-mt-12 flex flex-row  col-span-3 shadow-2xl">
            <div className="lg:basis-1/3 basis-1/2 relative overflow-hidden">
              <img
